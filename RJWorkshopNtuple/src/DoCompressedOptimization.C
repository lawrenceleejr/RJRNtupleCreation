...
int main(int argc, char* argv[]) {
  ...
  if ( argc < 3 ){
    ...
    cout << "Example:   ./DoCompressedOptimization.x -sfile=signal.root -bfold=bkg_folder -ofile=output.root" << endl;
    cout << "Example:   ./DoCompressedOptimization.x -sfold=sig_folder -bfold=bkg_folder -ofile=output.root -Njob=1 -ijob=0" << endl;
    return 1;
  }
  ...
  CompressedOptimization Optimization;
