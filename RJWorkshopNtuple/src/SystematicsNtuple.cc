#include "SystematicsNtuple.hh"

using namespace RestFrames;



SystematicsNtuple::SystematicsNtuple(TTree* tree)
...
SystematicsNtuple::~SystematicsNtuple() {
  delete LAB;
  delete PP;
  delete Pa;
  delete Pb;
...
void SystematicsNtuple::InitOutputTree(){
  if(m_Tree)
    delete m_Tree;
...
void SystematicsNtuple::FillOutputTree(){

  // cout << "genweight " << NTVars_genWeight << endl;
  // cout << "ttbarweightHT " << NTVars_ttbarWeightHT << endl;
  // cout << "ttbarweightPt2 " << NTVars_ttbarWeightPt2 << endl;
  // cout << "ttbarAvgPt " << NTVars_ttbarAvgPt << endl;
  // cout << "WZweight " << NTVars_WZweight << endl;
  // cout << "nJet " << NTVars_nJet << endl;
  // cout << "nJetFatJet " << NTVars_nFatJet << endl;
  // cout << "MET " << NTVars_met << endl;
