...
int main(int argc, char* argv[]) {
  ...
  if ( argc < 3 ){
    ...
    cout << "Example:   ./DoOptimization.x -sfile=signal.root -bfold=bkg_folder -ofile=output.root -Njob=1 -ijob=0" << endl;
    cout << "Example:   ./DoOptimization.x -sfold=sig_folder -bfold=bkg_folder -ofile=output.root -Njob=1 -ijob=0" << endl;
    return 1;
  }
  ...
  GluinoOptimization Optimization;
