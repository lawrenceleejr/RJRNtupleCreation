#ifndef RJWorkshopNtuple_h
#define RJWorkshopNtuple_h
...
class RJWorkshopNtuple : public NtupleBase<ZeroLeptonBase> {

public:
  RJWorkshopNtuple(TTree* tree = 0);
  virtual ~RJWorkshopNtuple();
