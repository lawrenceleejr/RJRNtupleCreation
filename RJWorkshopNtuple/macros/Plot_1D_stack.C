...
void Plot_1D_stack(){
  ...
  g_PlotTitle = "Compressed SR4 N-1";
  ...
  // g_File.push_back("/Users/crogan/ALL_v57_pT50/BKG/GG_onestepCC.root");
  ...
  // g_Title.push_back("m_{#tilde{g}} = 1385, m_{#tilde{#chi}^{#pm}}= 705, m_{#tilde{#chi}} = 25");
   ...
   g_Hist.push_back(ihist);
   g_Bkg.push_back(false);
   g_Title.push_back("m_{#tilde{q}} = 500, m_{#tilde{#chi}} = 475");
   ihist++;
   ...
   // g_Hist.push_back(ihist);
   // g_Bkg.push_back(false);
   // g_Title.push_back("m_{#tilde{q}} = 500, m_{#tilde{#chi}} = 450");
   // ihist++;
   ...
   // g_Hist.push_back(ihist);
   // g_Bkg.push_back(false);
   // g_Title.push_back("m_{#tilde{q}} = 500, m_{#tilde{#chi}} = 400");
   // ihist++;

   // g_File.push_back("/Users/crogan/ALL_v57_pT50/SIG/SS_direct_comb.root");
   // g_Tree.push_back("SS_direct_500_300_SRAll");
   // g_Hist.push_back(ihist);
   // g_Bkg.push_back(false);
   // g_Title.push_back("m_{#tilde{q}} = 500, m_{#tilde{#chi}} = 300");
   // ihist++;
   ...
   // g_File.push_back("/Users/crogan/ALL_v57_pT50/SIG/GG_direct_comb.root");
   // g_Tree.push_back("GG_direct_800_600_SRAll");
   // g_Hist.push_back(ihist);
   // g_Bkg.push_back(false);
   // g_Title.push_back("m_{#tilde{g}} = 800, m_{#tilde{#chi}} = 600");
   // ihist++;
  ...
  for(int s = 0; s < Nsample; s++){
	...
	cout << "event " << e << " | " << Nentry << endl;
      ...
      if(m_Base->R_H2PP <= 0.4)
	return false;

      if(m_Base->R_HT3PP <= 0.4)
	return false;
	...
	return false;
     ...
     //  double dangle = (base->cosP-dphiVP)/2.;
      ...
      // 	continue;
       ...
       // if(acos(-1.)-base->dphiCMI < 1.8)
       // 	 continue;

       double weight = base->weight*g_Lumi;
       if(weight <= 0.)
	 weight = 1;
       hist[g_Hist[s]]->Fill(base->MS, base->weight*g_Lumi);
